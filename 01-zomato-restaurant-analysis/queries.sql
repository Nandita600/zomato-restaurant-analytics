...
-- name: restaurants_by_price_range
...
-- name: most_expensive_restaurants
...
SELECT
    ...
    "Aggregate rating"
FROM restaurants
ORDER BY "Average Cost for two" DESC
LIMIT 10;
-- name: most_expensive_restaurants
...
SELECT
    ...
    ROUND(AVG("Aggregate rating") FILTER (WHERE "Aggregate rating">0),2) AS average_rating,
